    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 50, "Mariusz", "Pudzianowski", 500 },
                    { 2, 20, "Adam", "Malysz", 180 },
                    { 3, 35, "Krzysztof", "Nowak", 120 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Wielki Miecz", 25 },
                    { 2, "Giga Kusza", 10 },
                    { 3, "Mikstura Zdrowia", 2 },
                    { 4, "Zapas Piwa", 12 },
                    { 5, "Mikstura Many", 3 },
                    { 6, "Skorzana zbroja", 12 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pogrmoca Blokow" },
                    { 2, "Wielki Czlowiek" },
                    { 3, "Najwiekszy z Polakow" },
                    { 4, "Zamieszkaly w domu" },
                    { 5, "Konsument Ryb" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, new DateTime(2024, 2, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, 3, new DateTime(2023, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, 5, new DateTime(2023, 12, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 1, new DateTime(2022, 7, 8, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, new DateTime(2022, 11, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 4, new DateTime(2021, 8, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
